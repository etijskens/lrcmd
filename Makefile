...
coverage: ## check code coverage quickly with the default Python
	coverage run --source lrcmd -m pytest
	coverage report -m
	coverage html
...
#-------------------------------------------------------------------------------
# Install package lrcmd in the current Python
# environment.
install: clean 
	pip install dist/$(module_name)-$(version)-py3-none-any.whl

#-------------------------------------------------------------------------------
# Uninstall package lrcmd from current Python environment
uninstall:
	pip uninstall $(module_name)
	
#-------------------------------------------------------------------------------
# Install package lrcmd in development mode 
